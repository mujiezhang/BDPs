...
### Fig.4
- a/b/c/d/f/g: script: `a-b-c-d-f-g.R`; data: `BDP-BUP-genome-szie-quality.tsv`, `protein_annotation_compare.tsv` and `BDP-vs-BUP-functional-gene.tsv`
- e/h/j: by Adobe Illustrator
- i: script: `i.R`, data: `genus_1_HSC-median.tsv`
- k: generated by [**clinker**](https://github.com/gamcil/clinker)
